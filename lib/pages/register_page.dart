...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Future<Map<String, String>> getCities() async {
    final response = await http.get(Uri.parse('http://dev.adsmap.kr.ua/api/v1/dictionary/public'));
    Map<String, dynamic> responseMap = jsonDecode(response.body)['cities'] as Map<String, dynamic>;
  ...
  Future<void> register() async {
    final uri = await http.post(Uri.parse('http://dev.adsmap.kr.ua/api/auth/register'),
